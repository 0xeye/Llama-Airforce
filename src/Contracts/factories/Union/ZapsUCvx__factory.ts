...
export class ZapsUCvx__factory {
  ...
  static createInterface(): ZapsUCvxInterface {
    return new Interface(_abi) as ZapsUCvxInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ZapsUCvx {
    return new Contract(address, _abi, runner) as unknown as ZapsUCvx;
  }
}
