...
export interface ZapsUFxsLpInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CRVETH_CRV_INDEX"
      | "CRVETH_ETH_INDEX"
...
export interface ZapsUFxsLp extends BaseContract {
  connect(runner?: ContractRunner | null): ZapsUFxsLp;
  ...
  CVXFXS_STAKING_CONTRACT: TypedContractMethod<[], [string], "view">;
  ...
  depositWithRewards: TypedContractMethod<
    [
  ...
  getFunction(
    nameOrSignature: "CVXFXS_STAKING_CONTRACT"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "depositWithRewards"
  ): TypedContractMethod<
    [
      lpTokenAmount: BigNumberish,
      crvAmount: BigNumberish,
